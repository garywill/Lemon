...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ app: UIApplication, open url: URL, options: [UIApplicationOpenURLOptionsKey : Any] = [:]) -> Bool {
    if url.absoluteString.hasPrefix(OAuthConstants.CallbackURLPrefix) {
      NotificationCenter.default.post(name: OAuthConstants.OAuthCallbackNotificationName, object: url)
      return true
    }
    return true
  }
